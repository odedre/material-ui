...
var getStyles = function getStyles(props, context, state) {
  var _slider, _track, _filledAndRemaining, _handle, _Object$assign, _Object$assign2;
  ...
  styles.filled = Object.assign({}, styles.filledAndRemaining, (_Object$assign = {}, _defineProperty(_Object$assign, mainAxisOffsetProperty[calculatedAxis], 0), _defineProperty(_Object$assign, 'backgroundColor', disabled ? trackColor : selectionColor), _defineProperty(_Object$assign, mainAxisMarginFromEnd[calculatedAxis], fillGutter), _defineProperty(_Object$assign, mainAxisProperty[calculatedAxis], 'calc(' + percent * 100 + '%' + calcDisabledSpacing + ')'), _Object$assign));
  styles.remaining = Object.assign({}, styles.filledAndRemaining, (_Object$assign2 = {}, _defineProperty(_Object$assign2, reverseMainAxisOffsetProperty[calculatedAxis], 0), _defineProperty(_Object$assign2, 'backgroundColor', (state.hovered || state.focused) && !disabled ? trackColorSelected : trackColor), _defineProperty(_Object$assign2, mainAxisMarginFromStart[calculatedAxis], fillGutter), _defineProperty(_Object$assign2, mainAxisProperty[calculatedAxis], 'calc(' + (1 - percent) * 100 + '%' + calcDisabledSpacing + ')'), _Object$assign2));
 ...
 * For Slider also see http://www.material-ui.com/#/components/slider
 * 
 *  
 * @example 
 * 
...
var Slider = function (_Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      var handleStyles = {};
      if (percent === 0) {
        handleStyles = Object.assign({}, styles.handle, styles.handleWhenPercentZero, active && styles.handleWhenActive, (hovered || focused) && !disabled && styles.handleWhenPercentZeroAndFocused, disabled && styles.handleWhenPercentZeroAndDisabled);
      } else {
        handleStyles = Object.assign({}, styles.handle, active && styles.handleWhenActive, disabled && styles.handleWhenDisabled);
      }

      var rippleStyle = Object.assign({}, styles.ripple, percent === 0 && styles.rippleWhenPercentZero);

      return _react2.default.createElement(
        'div',
        Object.assign({}, other, { style: prepareStyles(Object.assign({}, style)) }),
...
Slider.propTypes = {
  ...
  /**
   * @property {PropTypes.custom} defaultValue - The default value of the slider.
   */
  ...
  /**
   * @property {PropTypes.custom} max - The maximum value the slider can slide to on
   * a scale from 0 to 1 inclusive. Cannot be equal to min.
   */
  max: minMaxPropType,
  /**
   * @property {PropTypes.custom} min - The minimum value the slider can slide to on a scale
  ...
  /**
   * @property {PropTypes.custom} value - The value of the slider.
   */
