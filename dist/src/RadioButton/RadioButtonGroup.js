  ...
  _createClass(RadioButtonGroup, [{
    ...
    value: function render() {
      ...
      var options = _react2.default.Children.map(this.props.children, function (option) {
        ...
        return _react2.default.createElement(_RadioButton2.default, Object.assign({}, other, {
...
RadioButtonGroup.propTypes = {
  ...
  /**
   * @property {PropTypes.string.isRequired} name - The name that will be applied to all child radio buttons.
   */
